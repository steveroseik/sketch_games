      ...
      child: Scaffold(
        ...
        body: SafeArea(
          child: Padding(
            ...
            child: loading ? loadingWidget(loading) : Column(
              children: [
                Text('SKETCH GAMES',
                style: TextStyle(
                  fontFamily: 'Quartzo',
      ...
      try{
        if (validateEmail(usernameField.text)){
          ...
          if (data.docs.isNotEmpty){
            ...
            if (team.loggedIn >= 3){
              showNotification(context, 'This team has reached maximum login sessions!', error: true);
            }else{
              await FirebaseFirestore.instance.doc(team.id).update({
                'loggedIn': FieldValue.increment(1)
              });
